...
<head>
    ...
    <title>:: Surgerry Management Admin ::</title>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li> <a href="javascript:void(0);" class="menu-toggle"><i
                                class="zmdi zmdi-copy"></i><span>Service</span> </a>
                        <ul class="ml-menu">
                            <li><a href="doctorpermission.php">View Treatment Records</a></li>
                            <li><a href="http://localhost:8081/record">Add Treatment Record</a></li>
                        </ul>
                    </li>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                        ...
                        <ul class="ml-menu">
                            <li><a  href="permission.php">Manage Prescription Records</a>
                            </li>
                        </ul>
                    </li>
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
