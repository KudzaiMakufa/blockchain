                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="text-sec padding-right-0">
                            <h5>Health Check Up At Our Surgery</h5>
                            <p>We exist entirely to provide access to good health and quality of life through our various healthcare centres, services and skills.</p>
                            <ul class="row">
                                <li class="col-sm-6">
