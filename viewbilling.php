...
if($rs[bill_type]  == "Prescription charge")
{
	...
	echo " </td><td>&nbsp;ZWL. $rs[bill_amount]</td></tr>";
    ...
    <table class="table table-bordered table-striped">
      <tbody>
        <tr>
          ...
          <td>&nbsp;ZWL. <?php echo $billamt; ?></td>
        </tr>
        <tr>
          <th width="442" scope="col"><div align="right">Tax Amount (5%) &nbsp; </div></th>
          	<td width="95">&nbsp;ZWL. <?php echo $taxamt = 5 * ($billamt / 100); ?>
            </td>
        </tr>
		...
		<tr>
		  ...
		  <td>&nbsp;ZWL. <?php echo ($billamt + $taxamt)  - $rsbilling_records[discount] ; ?></td>
	    </tr>
      </tbody>
    </table>
