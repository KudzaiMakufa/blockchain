          ...
          <select name="select4" id="select4" class="form-control show-tick">
           <option value="">Select</option>
			...
			while($rstreatment=mysqli_fetch_array($qsqltreatment))
			{
				...
				{
				echo "<option value='$rstreatment[treatmentid]' selected>$rstreatment[treatmenttype]  - (ZWL. $rstreatment[treatment_cost])</option>";
				}
				else
				{
					echo "<option value='$rstreatment[treatmentid]'>$rstreatment[treatmenttype]  - (ZWL. $rstreatment[treatment_cost])</option>";
				}
