...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 01, 2020 at 09:54 AM
...
(1, 'Tawanda', 'admin', '123456789', 'Active', '');
...
(3, '', 2, 0, 1, '2020-03-15', '14:00:00', 1, 'Approved', 'TB checkup');
...
(3, 2, 3, '2020-03-15', '13:04:55', 0.00, 0.00, '', '00:00:00', '0000-00-00');
...
(4, 3, 1, 'Consultancy Charge', 7.00, '2020-03-15', 'Active'),
(5, 3, 21, 'Treatment', 120.00, '2020-03-15', 'Active'),
(6, 3, 21, 'Treatment', 120.00, '2020-03-15', 'Active'),
(7, 3, 21, 'Treatment', 120.00, '2020-03-15', 'Active'),
(8, 3, 2, 'Prescription Charge', 15.00, '2020-03-15', 'Active');
...
(1, 'Maroso', '0773812069', 1, 'admin', '123456789', 'Active', 'MBBS', 7.0, 7.00);
...
(2, 'Cotri', 5.00, 'Antiobiotic', 'Active');
...
(1, 'Chido', '2019-06-15', '18:47:22', 'Vengere', '2125798361', 'Rusape', '1207', 'admin', '123456789', 'O+', 'MALE', '1990-01-01', 'Active'),
(2, 'Rutendo', '2020-02-26', '21:24:59', 'Damafalls', '0774588842', 'Harare', '2201', 'Rutendo99', '602101', 'AB-', 'FEMALE', '1999-09-30', 'Active');
...
(4, 21, 3, 2, 1, 'First stage of TB', '1048790590', '2020-03-15', '14:04:00', 'Active');
...
--
ALTER TABLE `billing_records`
  MODIFY `billingservice_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
